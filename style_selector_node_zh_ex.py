...
style_list = [
    ...
    {
        "name": "【神秘·街灯邂逅】(Street Lamp Encounter)",
    ...
    {
        "name": "梦幻海滩高调 (Dreamy Beach High-Key)",
    ...
    {
        "name": "清透夏日柔光 (Clear Summer Soft Light)",
    ...
    {
        "name": "胶片质感夏日 (Vintage Film Summer)",
    ...
    {
        "name": "水光粼粼折射 (Water Caustics & Sparkle)",
    ...
    {
        "name": "北极光 (Aurora Borealis)",
        "prompt": "{prompt}, aurora borealis lighting, ethereal green and purple glow, mystical night, fantasy atmosphere, celestial vibe",
        "negative_prompt": "",
    },
    {
        "name": "狗仔队闪光灯 (Paparazzi Flash)",
    ...
    {
        "name": "百叶窗阴影 (Venetian Blind Shadows)",
    ...
    {
        "name": "王道 - 清纯制服 (Seifuku)",
        "prompt": "{prompt}, 清楚なアイドル, 制服ポートレート, 紺色のブレザー, チェック柄のスカート, 赤いリボン, 教室の窓際, 自然光, 夕日, 放課後の雰囲気, 黒髪ロングストレート, ナチュラルメイク, 青春感, エモい",
        "negative_prompt": "派手なメイク, 露出過多, スタジオ照明, ファンタジー要素, 暗い",
    },
    {
        "name": "王道 - 约会私服 (Girlfriend Date)",
        "prompt": "{prompt}, 私服スナップ, 彼女感, デート中の視線, ゆるふわニット, 萌え袖, オフショルダー, カフェのテラス席, ラテを持つ手, 優しい微笑み, 柔らかい雰囲気, 自然な髪型, 休日, インスタ映え",
        "negative_prompt": "ステージ衣装, 硬い表情, ビジネスライク, 派手な背景, ネオン",
    },
    {
        "name": "王道 - 半双马尾 (Half-Twin / Ryousangata)",
        "prompt": "{prompt}, ハーフツインテール, 巻き髪（curled hair）, パール付きのヘアクリップ, パステルピンクのブラウス, 量産型メイク, うるうるの瞳, 自撮りポーズ, 甘い雰囲気, アイドル楽屋, ドアップ",
        "negative_prompt": "ボーイッシュ, シンプルすぎる, 暗い色調, 直毛",
    },
    {
    ...
    {
        "name": "Cosplay - 赛车女郎-☂️ (Race Queen)",
...
juese_list = [
    ...
    {
        "name": "FeiFei Kpop",
        "prompt": "Name: FeiFei,Korean Female Model,Age: 19, Body Type: Petite and toned, with a curvy silhouette,Physical Description: Skin: Clear, translucent, natural texture; with a subtle Korean glow,Figure: Hourglass, with a toned physique honed from years of rigorous training and performance schedule; ",
    },
    {
        "name": "FeiFei Jpop",
